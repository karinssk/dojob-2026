            ...
            <div class="project-header bg-white border-bottom p-3 mb-3" id="project-header-section">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="project-actions">
                        <a href="<?php echo get_uri('projects/view/' . $project_info->id); ?>" class="btn btn-outline-secondary btn-sm">
                            <i data-feather="external-link" class="icon-16 me-1"></i>
                            <?php echo app_lang('view_project'); ?>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" id="task-list-column">
                                    ...
                                    <div class="task-list-container" id="task-list-container">
                                        ...
                                        <!-- Task Table -->
                                        <div class="table-responsive" style="max-height: calc(70vh - 80px); overflow-x: auto; overflow-y: auto;">
