<div id="proposal-comment-container-<?php echo $comment->id; ?>" class="comment-container b-t pt15">
        ...
        <div class="w-100">
            <div class="d-flex">
                ...
                <?php if ($login_user->is_admin || $comment->created_by == $login_user->id) { ?>
                    <div class="flex-shrink-0 proposal-comment-dropdown">
                        <span class="float-end dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" role="menu">
                                <li role="presentation"><?php echo ajax_anchor(get_uri("proposals/delete_comment/$comment->id"), "<i data-feather='x' class='icon-16'></i> " . app_lang('delete'), array("class" => "dropdown-item", "title" => app_lang('delete'), "data-fade-out-on-success" => "#proposal-comment-container-$comment->id")); ?> </li>
                            </ul>
                        </span>
                    </div>
                <?php } ?>
            ...
            <div class="comment-image-box clearfix w-auto">
                ...
                if ($total_files) {
                    ...
                    echo anchor(get_uri("proposals/download_comment_files/" . $comment->id), $download_caption, array("class" => "float-end", "title" => $download_caption));
                }
                ?>
            </div>
        </div>
