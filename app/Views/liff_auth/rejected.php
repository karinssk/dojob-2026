...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .reason-box{background:#FFF0F3;border:1.5px solid #F9A8C9;border-radius:14px;padding:14px 16px;margin-bottom:24px;text-align:left}
