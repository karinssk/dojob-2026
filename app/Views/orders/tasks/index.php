<div class="card">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            <?php echo modal_anchor(get_uri("tasks/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_task'), array("class" => "btn btn-default mb0", "data-post-order_id" => $order_id, "title" => app_lang('add_task'))); ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#task-table").appTable({
            source: '<?php echo_uri("tasks/list_data/order/" . $order_id) ?>',
            order: [[0, "desc"]],
            serverSide: true,
            columns: [
