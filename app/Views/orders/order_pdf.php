<div style=" margin: auto;">
    ...
    $total_after_discount_row = '<tr>
                                    ...
                                    <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">' . to_currency($order_total_summary->order_subtotal - $order_total_summary->discount_total) . '</td>
                                </tr>';
    ?>
</div>
