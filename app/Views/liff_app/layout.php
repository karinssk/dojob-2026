...
<nav class="bottom-tabs">
  ...
  <a class="bottom-tab <?= ($active_tab ?? '') === 'tasks'    ? 'active' : '' ?>" href="<?= get_uri('liff/app/tasks') ?>">
    <span class="bottom-tab-icon">
      <svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M9 12l2 2 4-4M7 4h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </span>
    <span class="bottom-tab-label">Tasks</span>
  </a>
  <a class="bottom-tab <?= ($active_tab ?? '') === 'projects' ? 'active' : '' ?>" href="<?= get_uri('liff/app/projects') ?>">
    <span class="bottom-tab-icon">
      <svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </span>
    <span class="bottom-tab-label">Projects</span>
  </a>
  <a class="bottom-tab <?= ($active_tab ?? '') === 'events'   ? 'active' : '' ?>" href="<?= get_uri('liff/app/events') ?>">
    <span class="bottom-tab-icon">
      <svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M8 3v4M16 3v4M3 10h18M5 5h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </span>
