...
<div id="events-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <?php if (get_setting('enable_line_notifications')): ?>
            <div class="form-group">
                <div class="row">
                    <label for="line_notify_enabled" class=" col-md-3 col-xs-5 col-sm-4"><?php echo app_lang('line_notify'); ?></label>
                    <div class=" col-md-9 col-xs-7 col-sm-8">
                        <?php
                        echo form_checkbox("line_notify_enabled", "1", $model_info->line_notify_enabled ? true : false, "id='line_notify_enabled' class='form-check-input'");
                        ?>
                        <span class="form-check-label ml-2"><?php echo app_lang('enable_line_notifications_for_event'); ?></span>
                    </div>
                </div>
            </div>
            <?php endif; ?>
