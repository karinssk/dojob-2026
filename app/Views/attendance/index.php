<div id="page-content" class="page-wrapper clearfix grid-button">
    ...
    <div class="card">
        <ul id="attendance-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title scrollable-tabs" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("attendance/calendar"); ?>" data-bs-target="#calendar-attendance"><?php echo app_lang('calendar'); ?></a></li>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="calendar-attendance"></div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            if (tab === "members_clocked_in") {
                ...
                $("[data-bs-target='#calendar-attendance']").trigger("click");
            }
        }, 210);
