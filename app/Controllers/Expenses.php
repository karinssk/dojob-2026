...
class Expenses extends Security_Controller {
    ...
    function index() {
        ...
        $view_data['months_dropdown'] = $this->_get_months_dropdown();
    ...
    //get months dropdown
    private function _get_months_dropdown() {
        $months_dropdown = array(array("id" => "", "text" => "- " . app_lang("month") . " -"));
        ...
        foreach ($years as $year) {
            foreach ($months as $month_num => $month_name) {
                ...
                $months_dropdown[] = array("id" => $value, "text" => $text);
            }
        }
        
        return json_encode($months_dropdown);
    }
    ...
    function list_data($recurring = false) {
        ...
        $month_filter = $this->request->getPost('month_filter');
        ...
        $options = array("start_date" => $start_date, "end_date" => $end_date, "category_id" => $category_id, "project_id" => $project_id, "user_id" => $user_id, "month_filter" => $month_filter, "custom_fields" => $custom_fields, "recurring" => $recurring, "custom_field_filter" => $this->prepare_custom_field_filter_values("expenses", $this->login_user->is_admin, $this->login_user->user_type));
    ...
    function file_preview($id = "", $key = "") {
        if ($id) {
            ...
            $view_data["all_files"] = $files;
            $view_data["current_file_index"] = $key;
            $view_data["expense_id"] = $id;
